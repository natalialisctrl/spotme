...
export async function generatePersonalityInsights(
  ...
  try {
    ...
    // Fallback with generic insights in case of error
    return {
      workoutStyle: "Your workout style will be determined based on your personal preferences and goals.",
      motivationTips: [
      ...
      partnerPreferences: "Look for a gym partner with similar fitness goals and schedule compatibility."
    };
  }
}